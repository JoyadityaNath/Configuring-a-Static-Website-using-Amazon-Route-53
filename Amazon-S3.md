...
In the [next section](Route-53.md#, we will see how using Route 53's Hosted Zone section we can enable customers to use both of your custom URLs to navigate to your site.
